...
const Top =()=>{
    return(
        <div className={`container overflow-hidden`}>
            ...
            <p data-aos='fade-up' data-aos-offset='80' className={styles.content}>test 5</p>
            ...
            <div className={`row ${styles.contain} flex-column-reverse flex-md-row`}>
                <div data-aos='slide-right' className={`col-md-6`}>
                    ...
                    <p className={styles.creativity}>Innovation in our core</p>
                    <p className={styles.contn}>Lets do it together</p>
                </div>
