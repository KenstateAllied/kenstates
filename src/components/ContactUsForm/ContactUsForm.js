    ...
    return(
        <>
            <div className={`container ${styles.contain} overflow-hidden`}>
                <p data-aos='fade-up' className={`${styles.heading} mx-auto`}>Get in touch, we will deliver your product</p>
                ...
                <div className="row">
                    ...
                    <div className="col-md-4" data-aos='fade-left' data-aos-offset='70'>
                        ...
                        <p className={styles.content}>Monday - Saturday: 08:00 - 5:00</p>
